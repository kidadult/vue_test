...
<!--    <div class="mui-card">
      ...
      <div class="mui-card-content">
        <div class="mui-card-content-inner">
          ...
          <p>
            ...
            &lt;!&ndash; 分析： 如何实现加入购物车时候，拿到 选择的数量 &ndash;&gt;
            &lt;!&ndash; 1. 经过分析发现： 按钮属于 goodsinfo 页面， 数字 属于 numberbox 组件 &ndash;&gt;
            &lt;!&ndash; 2. 由于涉及到了父子组件的嵌套了，所以，无法直接在 goodsinfo 页面zhong 中获取到 选中的商品数量值&ndash;&gt;
            &lt;!&ndash; 3. 怎么解决这个问题：涉及到了 子组件向父组件传值了（事件调用机制） &ndash;&gt;
            &lt;!&ndash; 4. 事件调用的本质： 父向子传递方法，子调用这个方法， 同时把 数据当作参数 传递给这个方法 &ndash;&gt;
          </p>
        </div>
      </div>
    </div>-->
    ...
    <div class="mui-card">
      <div class="mui-card-header">Apple iPhone 13 (A2634) 256GB 星光色 支持移动联通电信5G 双卡双待手机【赠大王卡首月免月租】</div>
      <div class="mui-card-content">
        <div class="mui-card-content-inner">
          <p class="price">
            市场价：<del>￥888</del>&nbsp;&nbsp;销售价：<span class="now_price">￥999</span>
          </p>
<!--          <p>购买数量：<numbox @getcount="getSelectedCount" :max="goodsinfo.stock_quantity"></numbox></p>-->
            购买数量:
...
export default {
  data() {
    return {
      ...
      lunbotu: [
        {
          src: 'https://img13.360buyimg.com/n5/s54x54_jfs/t1/79182/30/16510/139329/6141649fE90cf36d3/ec179a32a8ae286f.jpg',
        },
        {
        ...
        {
          src: 'https://picsum.photos/id/5/300/200',
        },
      ], // 轮播图的数据
      goodsinfo: {}, // 获取到的商品的信息
